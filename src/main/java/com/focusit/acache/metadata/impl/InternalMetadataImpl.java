package com.focusit.acache.metadata.impl;
...
import com.focusit.acache.metadata.InternalMetadata;
...
public class InternalMetadataImpl implements InternalMetadata {
	...
	public String toString() {
		return "InternalMetadataImpl{" + "actual=" + actual + ", created=" + created + ", lastUsed=" + lastUsed + '}';
	}
