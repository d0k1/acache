...
public class DummyBaseTransactionManager implements TransactionManager, Serializable {
   ...
   private static final Logger log = LoggerFactory.getLogger(DummyBaseTransactionManager.class);
   ...
   public Transaction suspend() throws SystemException {
      ...
      setTransaction(null);
      if (trace) log.trace(String.format("Suspending tx %s", retval));
      return retval;
   }
   ...
   public void resume(Transaction tx) throws InvalidTransactionException, IllegalStateException, SystemException {
      if (trace) log.trace(String.format("Resuming tx %s", tx));
      setTransaction(tx);
   }
