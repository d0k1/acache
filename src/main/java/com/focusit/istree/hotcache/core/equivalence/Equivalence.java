 ...
 * collection extensions within the Infinispan code base contain references to
 * them, and since these are potentially {@link Serializable}, they might be
 * persisted somehow.
 *
...
public interface Equivalence<T> extends Serializable {
	 ...
	 *
	 * As an example, implementors can provide an alternative implementation for
	 * the hash code calculation for arrays. So, instead of relying on
	 * {@link Object#hashCode()}, call {@link java.util.Arrays.hashCode()}.
	 *
	 * @param obj
	 *            instance to calculate hash code for
	 ...
	 *
	 * As an example, implementors can provide an alternative implementation for
	 * the equals for arrays. So, instead of relying on
	 * {@link Object#equals(Object)}}, call {@link java.util.Arrays.equals())}.
	 *
	 * @param obj
	 *            to be compared with second parameter
	 * @param otherObj
	 *            to be compared with first parameter
	...
	/**
	 * Returns whether the given object is comparable. In other words, if given
	 * an instance of the object, a sensible comparison can be computed using
	 * {@link #compare(Object, Object)} method.
	 *
	 * @param obj
	 *            instance to check if it's comparable
	 * @return <code>true</code> if the object is comparable; <code>false</code>
	 *         otherwise
	 */
	boolean isComparable(Object obj); // For future support for objects that are
										// not comparable, i.e. arrays
	 ...
	 */
	int compare(T obj, T otherObj); // For future support for objects that are
									// not comparable, i.e. arrays
