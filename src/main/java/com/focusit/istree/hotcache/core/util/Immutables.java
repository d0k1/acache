...
public class Immutables {
	...
	/**
	 * Creates a new immutable list containing the union (combined entries) of
	 * both lists.
	 *
	 * @param list1
	...
	/**
	 * Wraps a collection with an immutable collection. There is no copying
	 * involved.
	 *
	 * @param collection
	 *            the collection to wrap
	 * @return an immutable collection wrapper that delegates to the original
	 *         collection
	 */
	...
	/**
	 * Wraps a {@link Map.Entry}} with an immutable {@link Map.Entry}}. There is
	 * no copying involved.
	 *
	 * @param entry
	 *            the mapping to wrap.
	 * @return an immutable {@link Map.Entry}} wrapper that delegates to the
	 *         original mapping.
	 */
	...
	private static class ImmutableSetWrapper<E> extends ImmutableCollectionWrapper<E>
			implements Set<E>, Serializable, Immutable {
	...
	private static class ImmutableReversibleOrderedSetWrapper<E> extends ImmutableCollectionWrapper<E>
			implements ReversibleOrderedSet<E>, Serializable, Immutable {
		private static final long serialVersionUID = 7991492805176142615L;
