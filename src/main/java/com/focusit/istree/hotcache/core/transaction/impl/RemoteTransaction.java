...
import com.focusit.istree.hotcache.core.transaction.xa.InvalidTransactionException;
...
public class RemoteTransaction extends AbstractCacheTransaction implements Cloneable {
   ...
   public void putLookedUpEntry(Object key, CacheEntry e) {
      ...
      if (log.isTraceEnabled()) {
         log.trace(String.format("Adding key %s to tx %s", key, getGlobalTransaction()));
      }
   ...
   public void putLookedUpEntries(Map<Object, CacheEntry> entries) {
      checkIfRolledBack();
      if (log.isTraceEnabled()) {
         log.trace(String.format("Adding keys %s to tx %s", entries.keySet(), getGlobalTransaction()));
      }
