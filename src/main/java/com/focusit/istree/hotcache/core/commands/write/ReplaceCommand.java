...
import com.focusit.istree.hotcache.core.commands.MetadataAwareCommand;
...
public class ReplaceCommand/* extends AbstractDataWriteCommand */implements MetadataAwareCommand {
	...
	// CacheNotifier notifier, Metadata metadata, Set<Flag> flags, Equivalence
	// valueEquivalence,
	...
	// this.valueMatcher = oldValue != null ? ValueMatcher.MATCH_EXPECTED :
	// ValueMatcher.MATCH_NON_NULL;
	...
	// // We need the null check as in non-tx caches we don't always wrap the
	// entry on the origin
	// if (e != null && valueMatcher.matches(e, oldValue, newValue,
	// valueEquivalence)) {
	// e.setChanged(true);
	...
	// }
	//
	// private Object returnValue(Object beingReplaced, Metadata
	// previousMetadata, boolean successful,
	...
	// Flag.copyWithoutRemotableFlags(flags), commandInvocationId};
	// }
	//
	// @Override
	// @SuppressWarnings("unchecked")
	// public void setParameters(int commandId, Object[] parameters) {
	// if (commandId != COMMAND_ID) throw new IllegalArgumentException("Invalid
	// method name");
	// key = parameters[0];
	...
	// null) return false;
	// if (newValue != null ? !newValue.equals(that.newValue) : that.newValue !=
	// null) return false;
	// if (oldValue != null ? !oldValue.equals(that.oldValue) : that.oldValue !=
	// null) return false;
	//
	// return true;
	// }
