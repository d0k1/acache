...
/**
 * Abstract class that provides a method to round up to the nearest value of 8
 * which is important for most jvm when doing size calculations. This is due to
 * the fact that most JVMs align to the nearest 8 bytes for addressing purposes.
 * {@inheritDoc}
 */
