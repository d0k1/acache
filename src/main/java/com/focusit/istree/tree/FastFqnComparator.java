...
public class FastFqnComparator implements Comparator<FastFqn>, Serializable {
	 ...
	 * second FastFqn comes before. <code>null</code> always comes first.
	 */
	@Override
	public int compare(FastFqn fqn1, FastFqn fqn2) {
		...
		// return
		// sfqn1.stringRepresentation.compareTo(sfqn2.stringRepresentation);
		// }
	...
	/**
	 * Compares two FastFqn elements. If e1 and e2 are the same class and e1
	 * implements Comparable, returns e1.compareTo(e2). Otherwise, returns
